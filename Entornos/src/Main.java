...
/**
 * Clase que prueba los m�todos de la clase CCuenta
 * @author Iv�nManso
 * @version v1.0
 * @since 30/11/2021
 */
public class Main {
	static BufferedReader dato = new BufferedReader(new InputStreamReader(System.in));//comentario para el git
/**
 * 
 * @param args
 */
...
*/
		...
		InterfazCuentaCorriente cuenta2 = new CuentaCorriente("Jaime L�pez", "1444-2445-84-123456789", 1000, 0);
		visualizarDatosCuenta(cuenta1, cuenta2, "Buenos d�as");
	}
/**
 * @param cuenta1
 * @param cuenta2
...
/**
 * M�todo para retirar o ingresar dinero en una cuenta
 * @param cuenta1
 * @param cantidad
 * @param opcion
 */
